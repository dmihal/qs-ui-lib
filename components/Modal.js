  ...
  render() {
    return (
      <div className="modal">
        ...
        <label htmlFor={'modal-trigger-' + this.props.modalID} className="open-modal" ref={this.modalTrigger} />
        <div className="modal-overlay">
          <label htmlFor={'modal-trigger-' + this.props.modalID} className="o-close" onClick={this.checkBox}/>
          <div className={
            "modal-wrap " + ( 
