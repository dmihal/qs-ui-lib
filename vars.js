...
// -----------------------------------------------------------------------------
export const Colors = {
  colorPrimaryRoyal: 'rgba(5,40,146,1)',
  colorPrimaryMalibu: 'rgba(76,187,253,1)',
  colorPrimaryPoloBlue: 'rgba(131,174,216,1)',
  colorPrimarySlate: 'rgba(112,128,144,1)',
  colorPrimaryGallery: 'rgba(238,238,238,1)',
  colorPrimaryAlabaster: 'rgba(249,249,249,1)',
  colorPrimaryMirage: 'rgba(30,40,55,1)',
  colorPrimaryLaPalma: 'rgba(17,168,23,1)',
  colorPrimaryAtlantis: 'rgba(125,202,70,1)',
  colorPrimaryYellow: 'rgba(255,184,0,1)',
  colorPrimaryCrusta: 'rgba(255,126,46,1)',
