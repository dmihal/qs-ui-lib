...
var CTAGrid = function CTAGrid(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    {
      className: _style2.default.dynamic([['1450357615', [_vars.MarginPaddingSize[2]]]]) + ' ' + 'CTAGrid'
    },
    children,
    _react2.default.createElement(_style2.default, {
      styleId: '1450357615',
      css: '.CTAGrid.__jsx-style-dynamic-selector{margin:auto;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between;width:100%;min-height:200px;}.CTAGrid.__jsx-style-dynamic-selector>*{border:1px solid #eee;min-height:' + _vars.MarginPaddingSize[2] + ';border-right:none;}.CTAGrid.__jsx-style-dynamic-selector>*:last-child{border-right:1px solid #eee;}',
