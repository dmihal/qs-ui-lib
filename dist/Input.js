...
var Input = function Input(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    {
      className: _style2.default.dynamic([['210955230', [_vars.MarginPaddingSize[4], _vars.Typography.fontSize[4], _vars.Colors.Slate, _vars.MarginPaddingSize[5], _vars.Colors.Cinnabar, _vars.Typography.fontSize[3], error ? _vars.Colors.Cinnabar : _vars.Colors.Mirage, _vars.Colors.Gallery, error ? _vars.Colors.Cinnabar : _vars.Colors.Gallery, _vars.MarginPaddingSize[5], _vars.MarginPaddingSize[5], error ? _vars.Colors.Cinnabar : _vars.Colors.Royal, search ? 'url(/' + require('qs-ui-library-asset-inliner/inlined/glyphs/glyph-search.svg.js') + ')' : null]]]) + ' ' + 'input-wrapper'
    },
