...
var CheckboxGroup = function CheckboxGroup(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'form',
      {
        className: _style2.default.dynamic([['1338728883', [_vars.MarginPaddingSize[4], _vars.Colors.Cinnabar, 'url(/' + require('../assets/glyphs/glyph-check.svg') + ')', error ? 'none' : 'url(/' + require('../assets/glyphs/glyph-check.svg') + ')']]])
      },
      options.map(function (option, index) {
        return _react2.default.createElement(
          'div',
          {
            ...
            className: _style2.default.dynamic([['1338728883', [_vars.MarginPaddingSize[4], _vars.Colors.Cinnabar, 'url(/' + require('../assets/glyphs/glyph-check.svg') + ')', error ? 'none' : 'url(/' + require('../assets/glyphs/glyph-check.svg') + ')']]]) + ' ' + ("checkbox-choice-wrap" + (option.disabled ? ' disabled' : '') + (option.deactive ? ' deactive' : '') + (option.error ? ' error' : '') || '')
          },
          _react2.default.createElement('input', { type: 'checkbox', id: option.label + index + nameID, name: nameID, disabled: option.disabled || option.error, className: _style2.default.dynamic([['1338728883', [_vars.MarginPaddingSize[4], _vars.Colors.Cinnabar, 'url(/' + require('../assets/glyphs/glyph-check.svg') + ')', error ? 'none' : 'url(/' + require('../assets/glyphs/glyph-check.svg') + ')']]])
          }),
          _react2.default.createElement(
            'label',
            { htmlFor: option.label + index + nameID, className: _style2.default.dynamic([['1338728883', [_vars.MarginPaddingSize[4], _vars.Colors.Cinnabar, 'url(/' + require('../assets/glyphs/glyph-check.svg') + ')', error ? 'none' : 'url(/' + require('../assets/glyphs/glyph-check.svg') + ')']]])
            },
            option.label
          )
        );
