...
var LinkCTA = function LinkCTA(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    {
      className: _style2.default.dynamic([['998074879', [!!onDark === true ? '#1e2837' : _vars.Colors.Gallery, !!onDark === true ? _vars.Colors.Malibu : _vars.Colors.Royal, _vars.Typography.fontSize[4], !!onDark === true ? 'black' : _vars.Colors.Royal, !!onDark === true ? 'black' : '', _vars.MarginPaddingSize[5], _vars.Typography.fontSize[4], !!onDark === true ? _vars.Colors.Malibu : '', _vars.MarginPaddingSize[5], _vars.MarginPaddingSize[5], _vars.MarginPaddingSize[5], !!onDark ? 'url( ' + require('../assets/glyphs/glyph-double-arrow-color-malibu.svg') + ')' : 'url( ' + require('../assets/glyphs/glyph-double-arrow.svg') + ')', _vars.Colors.Royal]]]) + ' ' + 'LinkCTA'
    },
