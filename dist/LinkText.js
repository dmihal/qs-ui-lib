...
var LinkText = function LinkText(_ref) {
  ...
  return _react2.default.createElement(
    'span',
    {
      className: _style2.default.dynamic([['1525873603', [_vars.Colors.Royal, _vars.Typography.fontSize[4], _vars.Colors.Royal]]]) + ' ' + 'LinkText'
    },
    arrow ? _react2.default.createElement('div', {
      className: _style2.default.dynamic([['1525873603', [_vars.Colors.Royal, _vars.Typography.fontSize[4], _vars.Colors.Royal]]]) + ' ' + 'arrow-right'
    }) : null,
    children,
...
LinkText.propTypes = {
   ...
   */
  activeState: _propTypes2.default.bool
};
